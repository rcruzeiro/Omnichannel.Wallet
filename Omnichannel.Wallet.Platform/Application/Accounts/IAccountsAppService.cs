...
namespace Omnichannel.Wallet.Platform.Application.Accounts
{
    public interface IAccountsAppService
    {
        ...
        Task<string> CreateGiftcard(CreateGiftcardCommand command, CancellationToken cancellationToken = default);
        Task Consume(ConsumeAccountCommand command, CancellationToken cancellationToken = default);
        Task Register(RegisterGiftcardCommand command, CancellationToken cancellationToken = default);
        Task Charge(ChargeGiftcardCommand command, CancellationToken cancellationToken = default);
